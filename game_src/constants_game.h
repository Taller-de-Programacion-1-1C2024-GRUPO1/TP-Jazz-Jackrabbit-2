...
#define HEALTHCARROT_DROP_PROBABILITY ConfigSingleton::getInstance().getHealthcarrotDropProbability()
...
#define ROTTENCHEESE_DROP_PROBABILITY ConfigSingleton::getInstance().getRottencheeseDropProbability()
#define MACHINEGUNAMMO_DROP_PROBABILITY ConfigSingleton::getInstance().getMachinegunammoDropProbability()
