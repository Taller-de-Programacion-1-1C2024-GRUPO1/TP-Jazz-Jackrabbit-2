...
void Bullet::on_colision_with_map(){
    kill();
}

void Bullet::on_colision_with(PhysicalObject* object) {
    object->on_colision_with_bullet(this);
}
...
void Bullet::bullet_killed_target(int amount_points){
    sender.add_points(amount_points);
}
